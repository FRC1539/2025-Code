...
public class RobotContainer {
        ...
        private final XboxController opController = new XboxController(RobotConstants.PortConstants.Controller.OP_CONTROLLER);
        ...
        //                                                                                   // command ends
                ...
                new Trigger(() -> opController.getRightTriggerAxis() > .1).whileTrue(clawSubsystem.intakeCoral()).onFalse(clawSubsystem.stopClaw());

                new Trigger(() -> opController.getLeftTriggerAxis() > .1).whileTrue(clawSubsystem.outtakeCoral()).onFalse(clawSubsystem.stopClaw());
